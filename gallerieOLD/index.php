...
<head>
    ...
    <style>
        .titre{font-weight: bold; font-size: 2.5em; color: #4f4f4f; text-align: center; display: block ;font-family: 'Neucha', cursive;}
        .date {font-weight: bold; font-size: 1.3em; color: #c3a53d; text-align: center; display: block}
    </style>
</head>
<body>
    <!-- page -->
