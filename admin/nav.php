  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-default fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php"><img src="../assets/img/logo-light.png" data-retina="true" alt="" width="134" height="41"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
     ...
     <!--  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tableau de bord">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Evenements">
          <a class="nav-link" href="evenements.php">
            <i class="fa fa-fw fa-paper-plane"></i>
            <span class="nav-link-text">Evènements</span>
          </a>
        </li>
          
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Appareils">
          <a class="nav-link" href="appareils.php">
            <i class="fa fa-fw fa-user"></i>
            <span class="nav-link-text">Appareils</span>
          </a>
        </li>
        
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Appareils">
          <a class="nav-link" href="reglages.php">
            <i class="fa fa-fw fa-user"></i>
            <span class="nav-link-text">Réglages</span>
          </a>
        </li>
